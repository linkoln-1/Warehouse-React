 ...
 return (
   ...
   >
    ...
    <div className="col-5 d-flex">
     <div><button className="delivery_method_button button_blue_step2 me-4" onClick={handleBack}>Назад</button></div>
     <div><button className="delivery_method_button" disabled={select === "выбрать"}>Далее</button></div>
    </div>

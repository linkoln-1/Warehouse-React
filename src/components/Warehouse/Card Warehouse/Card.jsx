    ...
    <div>
      <div className={styles.CardWarhouse}>
          <div className={styles.WarhouseKazanText}>
            ...
            <div>
              <img src={redactingImage} alt="" />
            </div>
          </div>
          <div className="border-bottom">
            <p style={{ color: "#17A2B8" }}>
              {props.item.data.address.zipcode},{" "}
              {props.item.data.address.country},{props.item.data.address.region}
              ,{props.item.data.address.city}, {props.item.data.address.street}{" "}
              {props.item.data.address.house}, {props.item.data.address.building}
            </p>
          </div>
        ...
        <div className={styles.ProductInStock}>
          <div>
            <span style={{marginRight:5, fontSize:30,color:"#17A2B8", fontWeight:500}}>
              230
            </span>
          ...
          >
          <div>
            <span style={{ fontSize:30, color:"#17A2B8",  fontWeight:500}}>1059</span>
            <div style={{color:"#A5A5A5"}}>
              Товаров в наличии
            </div>
          </div>
        ...
        <div className={styles.Methods}>
            <div>
              <span style={{fontSize:19, fontWeight:500}}>Методы доставки с этого склада:</span>
            </div>
            <div>
              <span style={{fontSize:19, color:"#A5A5A5", fontWeight:500}}>Добавить</span>
            </div>
        </div>
        ...
        <div className={styles.AddMethods}>
          ...
          <div style={{marginRight:180}}>
            <span style={{color:"#17A2B8"}}>245 заказов</span>
          </div>
